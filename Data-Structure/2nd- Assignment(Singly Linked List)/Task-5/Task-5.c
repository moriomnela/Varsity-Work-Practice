/*Task 5
Build on your knowledge by merging two sorted linked lists into one sorted list. Implement a function to do this while updating
 the head pointers correctly.*/
